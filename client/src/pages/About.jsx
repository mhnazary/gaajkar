...
function About() {
  ...
  const [aboutInfo, setAboutInfo] = useState({ title: t('about.title'), description: t('about.description') });
    ...
    <div className="container mx-auto p-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold mb-6">{aboutInfo.title}</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-700 mb-6">
                شرکت گاج برادران در سال 1380 تاسیس شد و از آن زمان تاکنون، با تکیه بر دانش فنی و تجربه، 
                به عنوان یکی از پیشگامان در صنعت ساختمان شناخته می‌شود. ما در پروژه‌های مسکونی، تجاری و اداری 
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold">500+ پروژه</div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold">50+ کارمند</div>
        ...
        {/* تیم استادکاران */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-center mb-12">تیم استادکاران ما</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 text-xs rounded-full">20 سال تجربه</span>
                  <span className="px-3 py-1 bg-green-100 text-green-800 text-xs rounded-full">مدیریت پروژه</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2">محمد حسینی</h3>
                <p className="text-gray-600 mb-3">مدیر فنی</p>
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 text-xs rounded-full">15 سال تجربه</span>
                  <span className="px-3 py-1 bg-green-100 text-green-800 text-xs rounded-full">نظارت کیفی</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 text-xs rounded-full">10 سال تجربه</span>
                  <span className="px-3 py-1 bg-green-100 text-green-800 text-xs rounded-full">مالی و حسابداری</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gray-50 rounded-xl p-8">
          <h2 className="text-3xl font-bold text-center mb-12">اهداف و ارزش‌های ما</h2>
        ...
        <div className="mt-16">
          <h2 className="text-3xl font-bold text-center mb-8">تیم ما در حال فعالیت</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <img 
              src="https://images.unsplash.com/photo-1541888941275-8c5da0f1a28d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1770&q=80" 
              alt="Team Working" 
              className="rounded-lg shadow-lg w-full h-64 object-cover"
            />
            <img 
              src="https://images.unsplash.com/photo-1503387720566-1e5b9ad5fdbe?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1770&q=80" 
              alt="Team Working" 
              className="rounded-lg shadow-lg w-full h-64 object-cover"
            />
            <img 
